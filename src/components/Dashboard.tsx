...
import { ArrowUpRight, ArrowDownRight, Package, DollarSign, Users, ShoppingCart, AlertTriangle, TrendingUp } from 'lucide-react';
...
export function Dashboard() {
  ...
  const lowStock = [
    { name: "Veste technique Arc'teryx", stock: 5, minimum: 15, sku: 'VET-001' },
    { name: 'Sac à dos Osprey 65L', stock: 8, minimum: 20, sku: 'SAC-012' },
    { name: 'Bottes randonnée Salomon', stock: 12, minimum: 25, sku: 'CHAUS-005' },
    { name: 'Tente 4 saisons MSR', stock: 3, minimum: 10, sku: 'CAMP-018' },
  ];

  const recentOrders = [
    { id: 'CMD-2456', client: 'Martin Tremblay', total: 1245.99, status: 'En traitement', date: '2025-11-01' },
    { id: 'CMD-2455', client: 'Sophie Gagnon', total: 789.50, status: 'Expédiée', date: '2025-11-01' },
    { id: 'CMD-2454', client: 'Jean Bélanger', total: 2134.25, status: 'Livrée', date: '2025-10-31' },
    { id: 'CMD-2453', client: 'Marie Côté', total: 456.75, status: 'En traitement', date: '2025-10-31' },
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600">Vue d'ensemble des opérations Nordik Adventures</p>
      </div>
            ...
            {lowStock.map((item) => (
              <div key={item.sku} className="space-y-2">
                ...
                <Progress 
                  ...
                  className="h-2"
                />
                <p className="text-xs text-slate-500">Minimum recommandé: {item.minimum} unités</p>
              </div>
            ))}
          </CardContent>
        </Card>
