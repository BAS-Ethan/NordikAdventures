...
import { Eye, Mail, Phone, FileText, StickyNote, Plus, Calendar, User as UserIcon } from 'lucide-react';
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Zone réservée aux employés - Suivez toutes les interactions avec vos clients
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div className="flex items-end">
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  <DialogTrigger asChild>
                    <Button className="bg-gradient-to-r from-emerald-700 to-teal-600">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div>
                ...
                <p className="font-semibold">
                  {new Date(selectedClient.createdAt).toLocaleDateString('fr-CA')}
                </p>
              </div>
            </div>
          </CardContent>
      ...
      {selectedUserId && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {filteredActivities.length} {filteredActivities.length > 1 ? 'activités' : 'activité'} enregistrées
            </CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-sm text-slate-500 flex items-center gap-1">
                          ...
                          {new Date(activity.timestamp).toLocaleDateString('fr-CA', {
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric',
                            hour: '2-digit',
                      ...
                      {activity.addedBy && (
                        <p className="text-xs text-slate-500 mt-1">
                          Ajouté manuellement par {mockUsers.find(u => u.id === activity.addedBy)?.name}
                        </p>
                      )}
                    </div>
                  </div>
